...
$(document).ready(function() {
    ...
    $('#nbrelem').change(function(){
        window.location.search = $.query.set("perPage", $(this).val());
    });

    $('.material-icons:contains(done_all)').click(function(){
        $(':checkbox').each(function(){$(this).prop('checked', true);})
    });

    $('.material-icons:contains(crop_square)').click(function(){
